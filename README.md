...
### For a Kotlin Multiplatform Project
 ...
 kotlin {
     sourceSets {
         commonMain.dependencies {
             ...
             implementation("io.github.jacksever.automapper:annotation:$VERSION")
         }
     }
 }
 ...
 dependencies {
     add("kspJs", "io.github.jacksever.automapper:processor:$VERSION")
     add("kspJvm", "io.github.jacksever.automapper:processor:$VERSION")
     add("kspIosX64", "io.github.jacksever.automapper:processor:$VERSION")
...
In a standard Android or JVM module, you can add the dependencies directly.
 ...
 dependencies {
     ...
     // KSP processor
     ksp("io.github.jacksever.automapper:processor:$VERSION")
 }
 ```
